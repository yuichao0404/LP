...
- 形式：Markdownまたはプレーンテキスト
- 内容：
  * セクションタイトルは##で記述
  * 画像の挿入位置には「【画像1挿入位置】」のようなプレースホルダーのみ記載
  * 画像のデザイン指示や生成プロンプトは一切含めない
  * テキストは適切な改行・段落分けで読みやすく整形
  * そのままコピー&ペーストしてLP作成に使える状態
  * 「セクション1」などの番号表記は含めない
...
- 形式：Markdown
- 内容：
  * 画像1～4の生成指示をそれぞれ独立したセクションで記載
  * 画像1：Canva編集用デザイン指示（日本語）
  * 画像2～4：AI生成プロンプト（英語、そのままMidjourney/DALL-Eに入力可能）
  * 各画像の役割・意図を明記
  * ワーカー向けのパラメータ調整ガイドも含める
